...
function promedioResultadosTest(resultadosTest) {
 ...
 for (let i = 0; i < resultadosTest.length; i++) {
    var promedio2 = promedio += resultadosTest[i];
    var promediofinal = promedio2/resultadosTest.length;
...
function continueStatement(numero) {
  ...
  // con la siguiente iteración. Pista: usá el statement 'continue'
  // Tu código:
  var Nuevoarray = [];
  var nuevasuma = numero;
  for (var i = 0; i < 10; i++) {
        if (i == 5) continue;
    else {
      nuevasuma += 2;
      Nuevoarray.push(nuevasuma);
    } 
    } return Nuevoarray;
}
